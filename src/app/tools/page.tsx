...
export default function WellnessLibrary() {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen flex flex-col items-center">
      <header className="flex items-center justify-between px-4 pt-12 pb-2 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md z-10 sticky top-0 w-full max-w-5xl">
        <button
          onClick={() => router.push("/")}
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar pb-24 w-full max-w-5xl">
        <div className="px-4 py-2 sticky top-14 bg-background-light dark:bg-background-dark z-10 pb-4 flex justify-center">
